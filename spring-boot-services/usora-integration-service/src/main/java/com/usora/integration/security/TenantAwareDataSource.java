 ...
 * TenantAwareDataSource.java for the full mechanism explanation. This
 * also fixes the previously-inert RLS setup found in
 * V2__tenant_schema.sql (ENABLE ROW LEVEL SECURITY with zero policies
 * defined, plus no FORCE — a complete no-op) — see
 * V3__row_level_security.sql for the full finding.
 */
